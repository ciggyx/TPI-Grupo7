...
{
    public class PendienteRevision : Estado
    {
        public PendienteRevision()
            : base() { }

        public static PendienteRevision Revisar()
        {
            return new PendienteRevision { Ambito = "EventoSismico", Nombre = "PendienteRevision" };
        }
